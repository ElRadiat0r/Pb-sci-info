...
INSERT INTO `avis` VALUES (1,1,1,3,5,'Un rÃ©gal !','2025-04-09 17:52:18'),(2,1,2,4,4,'DÃ©licieux.','2025-04-09 17:52:18'),(3,2,5,6,3,'Mon plat Ã©tait un peu froid.','2025-04-09 17:52:18');
...
INSERT INTO `ingredient` VALUES (6,'Champignons'),(8,'Chocolat'),(7,'CrÃ¨me fraÃ®che'),(3,'Fromage'),(11,'Lait'),(10,'Lardons'),(12,'Oeufs'),(9,'PÃ¢tes'),(2,'PÃ¢tes Ã  lasagnes'),(14,'Pommes'),(4,'Poulet'),(5,'Riz'),(13,'Sucre'),(1,'Tomates');
...
INSERT INTO `lignecommande` VALUES (1,1,1,2),(2,1,3,1),(3,1,5,1),(4,2,2,3),(5,2,6,2),(6,2,4,3),(9,4,1,3),(10,4,2,2),(11,4,7,4),(12,5,4,2),(13,5,6,2),(14,6,5,3),(15,6,7,2),(16,7,2,4),(17,7,5,2),(18,8,1,4),(19,8,6,3),(20,8,7,2),(21,9,4,3),(22,9,2,2),(23,10,3,3),(24,10,1,2),(25,11,7,2),(26,3,5,4),(27,3,4,4),(28,12,6,2),(29,12,7,1),(30,13,3,2);
...
INSERT INTO `plat` VALUES (1,4,'Lasagnes Ã  la bolognaise','2025-04-01',12.50,'Italienne','Omnivore'),(2,3,'Poulet Ã  la crÃ¨me et champignons','2025-04-02',13.00,'FranÃ§aise','Omnivore'),(3,3,'Riz au poulet faÃ§on thaÃ¯','2025-04-01',11.00,'ThaÃ¯landaise','Omnivore'),(4,4,'GÃ¢teau au chocolat','2025-04-01',6.50,'FranÃ§aise','VÃ©gÃ©tarien'),(5,4,'PÃ¢tes carbonara','2025-04-01',10.50,'Italienne','Omnivore'),(6,6,'Omelette aux lardons','2025-04-01',9.50,'FranÃ§aise','Omnivore'),(7,8,'Tartes aux pommes','2025-04-01',8.50,'FranÃ§aise','VÃ©gÃ©tarien');
...
-- Dump completed on 2025-05-05 14:58:08
